...
describe("ai-skills CLI E2E", () => {
  ...
  describe("info", () => {
    ...
    it("infrastructure --lang terraform shows terraform details", () => {
      const out = runCli("info infrastructure --lang terraform");
      expect(out).toContain("terraform");
      expect(out).toContain("azure");
    });

    it("unknown concept exits with error", () => {
      const { stdout, stderr } = runCliExpectFailure(
        "info nonexistent_concept_xyz",
      );
  ...
  describe("install (standard .ai-skills/)", () => {
    it("testing --lang python", () => {
      ...
      expect(
        fs.existsSync(
          path.join(TEST_DIR, ".ai-skills", "testing-python", "SKILL.md"),
        ),
      ).toBe(true);
    });
    ...
    it("testing --lang typescript", () => {
      ...
      expect(
        fs.existsSync(
          path.join(TEST_DIR, ".ai-skills", "testing-typescript", "SKILL.md"),
        ),
      ).toBe(true);
    });
    ...
    it("security", () => {
      ...
      expect(
        fs.existsSync(
          path.join(TEST_DIR, ".ai-skills", "security-general", "SKILL.md"),
        ),
      ).toBe(true);
    });
    ...
    it("architecture", () => {
      ...
      expect(
        fs.existsSync(
          path.join(TEST_DIR, ".ai-skills", "architecture-general", "SKILL.md"),
        ),
      ).toBe(true);
    });
    ...
    it("data-science --lang python", () => {
      ...
      expect(
        fs.existsSync(
          path.join(TEST_DIR, ".ai-skills", "data-science-python", "SKILL.md"),
        ),
      ).toBe(true);
    });
    ...
    it("code-review --lang python", () => {
      ...
      expect(
        fs.existsSync(
          path.join(TEST_DIR, ".ai-skills", "code-review-python", "SKILL.md"),
        ),
      ).toBe(true);
    });
    ...
    it("design --lang frontend", () => {
      ...
      expect(
        fs.existsSync(
          path.join(TEST_DIR, ".ai-skills", "design-frontend", "SKILL.md"),
        ),
      ).toBe(true);
    });
  });
  ...
  describe("init", () => {
    ...
    it(".ai-skills.json is valid JSON", () => {
      const content = fs.readFileSync(
        path.join(TEST_DIR, ".ai-skills.json"),
        "utf-8",
      );
