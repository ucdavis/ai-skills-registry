---
name: python
description: Performs structured code reviews on Python and FastAPI codebases covering correctness, async safety, security, Pydantic v2 patterns, testing, and style. Use when reviewing Python or FastAPI code, pull requests, or when asked to do a code review.
metadata:
  concept: code-review
  language: python
  category: engineering
  version: 1.0.0
  tags: [code-review, python, fastapi, pydantic, async]
---
